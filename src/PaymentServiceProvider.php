...
class PaymentServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app->bind('Payment', 'Cart53\Payment\Payment');

        $this->app->bind('Cart53\Payment\Gateways\PaymentGatewayInterface', 'Cart53\Payment\Gateways\\' . $gateway . 'Gateway');
    }
